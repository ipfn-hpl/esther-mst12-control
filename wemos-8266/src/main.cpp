...
{
  sensorIn = digitalRead(SWITCH_3_IN);
  sensorOut = digitalRead(SWITCH_3_OUT);
...
void print_serial() {
    Serial.print("S- ");
    Serial.print(state);
    Serial.print(" sensorIn: ");  Serial.print(sensorIn);
    Serial.print(" sensorOut: ");  Serial.print(sensorOut);
...
void loop() {
  ...
  if (millis() - lastRefreshTime >= REFRESH_INTERVAL) {
    lastRefreshTime += REFRESH_INTERVAL;
     ledOn = not ledOn;
     print_serial(); 
     //digitalWrite(LED_BUILTIN, ledOn); // D3
